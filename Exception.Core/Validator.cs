...
using Resx = Exception.Core.i18n.Validator_ResultMessages;
...
namespace Exception.Core
{
    public class Validator
    {
        ...
        private abstract class FluentValidator<TSource, TValidator, TValue> : IFluentValidator<TValidator> where TValidator : class
        {
            ...
            {
                Validator.Validate(Resx.Message_Property_Required, new { propertyName = PropertyName }, !defaultValues?.Contains(PropertyValue) ?? true);
                return This;
            }

            public TValidator IsValid(bool isValid)
            {
                Validator.Validate(Resx.Message_Value_Invalid, new { propertyName = PropertyName }, isValid);
                return This;
            }
            ...
            public TValidator IsValid(string translatedMessage, object tokens, bool isValid)
            {
                Validator.Validate(translatedMessage, tokens, isValid);
                return This;
            }

            public TValidator IsValid(string translatedMessage, object tokens, Func<bool> isValid)
            {
                Validator.Validate(translatedMessage, tokens, isValid);
                return This;
            }
        ...
        private class IntValidator<TSource> : FluentValidator<TSource, IIntValidator<TSource>, int?>, IIntValidator<TSource>
        {
            ...
            public IIntValidator<TSource> IsGreaterThanValue(int? value)
            {
                ...
                Validator.Validate(Resx.Message_Value_NotGreaterThanValue, tokens, PropertyValue > value);
            ...
            {
                var tokens = new { propertyName = PropertyName, value };
                Validator.Validate(Resx.Message_Value_NotGreaterThanOrEqualToValue, tokens, PropertyValue >= value);
            ...
            private IIntValidator<TSource> IsGreaterThan(string propertyName, int? propertyValue)
            {
                ...
                Validator.Validate(Resx.Message_Value_NotGreaterThan, tokens, PropertyValue > propertyValue);
                return this;
            }
            ...
            private IIntValidator<TSource> IsGreaterThanOrEqualTo(string propertyName, int? propertyValue)
            {
                ...
                Validator.Validate(Resx.Message_Value_NotGreaterThanOrEqual, tokens, PropertyValue >= propertyValue);
                return this;
            }
            ...
            {
                var tokens = new { propertyName = PropertyName, value };
                Validator.Validate(Resx.Message_Value_NotLessThanValue, tokens, PropertyValue < value);
            ...
            {
                var tokens = new { propertyName = PropertyName, value };
                Validator.Validate(Resx.Message_Value_NotLessThanOrEqualToValue, tokens, PropertyValue <= value);
            ...
            private IIntValidator<TSource> IsLessThan(string propertyName, int? propertyValue)
            {
                ...
                Validator.Validate(Resx.Message_Value_NotLessThan, tokens, PropertyValue < propertyValue);
                return this;
            }
            ...
            private IIntValidator<TSource> IsLessThanOrEqualTo(string propertyName, int? propertyValue)
            {
                ...
                Validator.Validate(Resx.Message_Value_NotLessThanOrEqual, tokens, PropertyValue <= propertyValue);
                return this;
            }
            ...
            public IIntValidator<TSource> HasValueInRange(int min, int max, RangeBoundaries boundaries = RangeBoundaries.AllInclusive)
            {
                ...
                switch(boundaries)
                {
                    case RangeBoundaries.AllInclusive:
                        Validator.Validate(Resx.Message_Value_NotWithinInclusiveRange, tokens, PropertyValue >= min && PropertyValue <= max);
                        break;
                    case RangeBoundaries.MaxInclusive:
                        Validator.Validate(Resx.Message_Value_NotWithinMaxInclusiveRange, tokens, PropertyValue > min && PropertyValue <= max);
                        break;
                    case RangeBoundaries.MinInclusive:
                        Validator.Validate(Resx.Message_Value_NotWithinMinInclusiveRange, tokens, PropertyValue >= min && PropertyValue < max);
                        break;
                    case RangeBoundaries.Exclusive:
                        Validator.Validate(Resx.Message_Value_NotWithinExclusiveRange, tokens, PropertyValue > min && PropertyValue < max);
                        break;
                    default:
        ...
        private class CollectionValidator<TSource> : FluentValidator<TSource, ICollectionValidator<TSource>, ICollection>, ICollectionValidator<TSource>
        {
            ...
            public ICollectionValidator<TSource> HasMinValues(int minValueCount)
            {
                ...
                Validator.Validate(Resx.Message_Collection_NotEnoughValues, tokens, PropertyValue?.Count >= minValueCount);
                return this;
            }
            ...
            public ICollectionValidator<TSource> HasMaxValues(int maxValueCount)
            {
                ...
                Validator.Validate(Resx.Message_Collection_TooManyValues, tokens, PropertyValue?.Count <= maxValueCount);
                return this;
            }
        }
        ...
        private class CollectionValidator<TSource, TValues> : FluentValidator<TSource, ICollectionValidator<TSource, TValues>, ICollection<TValues>>, ICollectionValidator<TSource, TValues>
        {
            ...
            public ICollectionValidator<TSource, TValues> HasValues()
            {
                ...
                Validator.Validate(Resx.Message_Collection_Empty, tokens, () => (PropertyValue?.Count ?? 0) > 0);
            ...
            public ICollectionValidator<TSource, TValues> HasMinValues(int minValueCount)
            {
                ...
                Validator.Validate(Resx.Message_Collection_NotEnoughValues, tokens, (PropertyValue?.Count ?? 0) >= minValueCount);
                return this;
            }
            ...
            public ICollectionValidator<TSource, TValues> HasMaxValues(int maxValueCount)
            {
                ...
                Validator.Validate(Resx.Message_Collection_TooManyValues, tokens, (PropertyValue?.Count ?? 0) <= maxValueCount);
                return this;
            }
        }
        ...
        public Validator Validate(string translatedMessage, object tokens, bool isValid)
        {
            return Validate(translatedMessage, tokens, () => isValid);
        }

        public Validator Validate(string translatedMessage, object tokens, Func<bool> validate)
        {
            if (!validate())
            {
                Errors.Add(Message.ValidationError(translatedMessage, tokens));
            }
        ...
        public Validator ValidatePropertyIsRequired(string propertyName, string propertyValue)
        {
            ...
            {
                Errors.Add(Message.ValidationError(Resx.Message_Property_Required, new { propertyName }));
            }
        ...
        public Validator ValidateStringMinLength(string propertyName, string propertyValue, int minLength)
        {
            ...
            {
                Errors.Add(Message.ValidationError(Resx.Message_MinStringLength_Violation, new { propertyName, minLength }));
            }
        ...
        public Validator ValidateStringLength(string propertyName, string propertyValue, int maxLength, int minLength = 0)
        {
            ...
            {
                Errors.Add(Message.ValidationError(Resx.Message_MaxStringLength_Exceeded, new { propertyName, maxLength }));
            }

            if (propertyValue?.Length < minLength || propertyValue?.Length > maxLength)
            {
                Errors.Add(Message.ValidationError(Resx.Message_StringLengthRange_Violation, new { propertyName, minLength, maxLength }));
            }
        ...
        public Validator ValidateCollectionHasValues(string collectionName, ICollection collection)
        {
            ...
            {
                Errors.Add(Message.ValidationError(Resx.Message_Collection_Empty, new { collectionName }));
            }
    ...
    public interface IFluentValidator<out TValidator>
    {
        ...
        TValidator IsValid(string translatedMessage, object tokens, bool isValid);
        TValidator IsValid(string translatedMessage, object tokens, Func<bool> isValid);
    }
